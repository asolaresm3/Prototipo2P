...
{
    public partial class Frm_Mantenimientos_Departamento : Form
    {
        Logica logic = new Logica();
        string scampo;
        public Frm_Mantenimientos_Departamento()
        {
            InitializeComponent();
        ...
        void bloquearTXT()
        {
            TextBox[] txtBox = { textBox1, textBox2}; //COLOCAR TODOS LOS TEXTBOX QUE SE UTILZIARAN
        ...
        {
            TextBox[] txtBox = { textBox1, textBox2}; //COLOCAR TODOS LOS TEXTBOX QUE SE UTILIZAN
            for (int i = 0; i < txtBox.Length; i++)
            {
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "departamento", textBox1.Text, textBox2.Text,comboBox1.Text };
                string[] campos = { "codigo_departamento", "nombre_departamento", "estado" };
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "concepto", textBox1.Text, textBox2.Text, comboBox1.Text };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            string[] valores = { "departamento", textBox1.Text, "codigo_departamento" };
        ...
        {
            Frm_Consult_Departamento depto = new Frm_Consult_Departamento();
            depto.ShowDialog();

            if (depto.DialogResult == DialogResult.OK)
            {
                textBox1.Text = depto.Dgv_consulta.Rows[depto.Dgv_consulta.CurrentRow.Index].
                      Cells[0].Value.ToString();
                textBox2.Text = depto.Dgv_consulta.Rows[depto.Dgv_consulta.CurrentRow.Index].
