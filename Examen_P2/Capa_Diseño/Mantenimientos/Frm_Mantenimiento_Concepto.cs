...
namespace Capa_Diseño.Mantenimientos
{
    public partial class Frm_Mantenimiento_Concepto : Form
    {
        ...
        {
            TextBox[] txtBox = { textBox1, textBox2,textBox3 }; //COLOCAR TODOS LOS TEXTBOX QUE SE UTILIZAN
            for (int i = 0; i < txtBox.Length; i++)
            {
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "concepto", textBox1.Text, textBox2.Text, textBox3.Text, comboBox1.Text };
                string[] campos = { "codigo_concepto", "nombre_puesto","efecto_concepto", "estado" };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            string[] valores = { "concepto", textBox1.Text, "codigo_concepto" };
        ...
        {
            Frm_Consult_Concepto concep = new Frm_Consult_Concepto();
            concep.ShowDialog();
            ...
            if (concep.DialogResult == DialogResult.OK)
            {
                ...
                textBox3.Text = concep.Dgv_consulta.Rows[concep.Dgv_consulta.CurrentRow.Index].
