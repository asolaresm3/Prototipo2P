...
{
    public partial class Frm_Mantenimiento_Puesto : Form
    {
        Logica logic = new Logica();
        string scampo;
        public Frm_Mantenimiento_Puesto()
        {
            InitializeComponent();
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "puesto", textBox1.Text, textBox2.Text,comboBox1.Text };
                string[] campos = { "codigo_puesto", "nombre_puesto", "estado"};
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ...
            string[] valores = { "puesto", textBox1.Text, "codigo_puesto" };
        ...
        {
            Frm_Consult_Puesto puesto = new Frm_Consult_Puesto();
            puesto.ShowDialog();

            if (puesto.DialogResult == DialogResult.OK)
            {
                textBox1.Text = puesto.Dgv_consulta.Rows[puesto.Dgv_consulta.CurrentRow.Index].
                      Cells[0].Value.ToString();
                textBox2.Text = puesto.Dgv_consulta.Rows[puesto.Dgv_consulta.CurrentRow.Index].
